    ...
    <footer>
        ...
        <div class="social-media">
            ...
            <a href="https://www.whatsapp.com" class="social-icon whatsapp">
                <h1 style="display: none;">WhatsApp</h1>
            ...
            <a href="https://www.discord.com" class="social-icon discord">
                <h1 style="display: none;">Discord</h1>
        ...
        <p>2012 - {{ currentYear }} &copy; <a href="https://hauknet.eu" style="text-decoration: none; color: aqua;">Vecto.</a> | All rights reserved.</p>
    </footer>
</template>
